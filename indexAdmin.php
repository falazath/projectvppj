        ...
        <table class="table table-light table-bordered">
            <thead>
                <tr class="d-flex text-center fsub">
                    <th class="col-3 col-sm-2 col-xl-1">วันที่</th>
            ...
            <tbody>
                ...
                for ($j = 0; $j < count($row); $j++) {
                    ...
                    echo '<tr class="d-flex text-center fsub">
                                <td class="col-3 col-sm-2 col-xl-1" id="date">' . convertDate($Form_date) . '</td>';
                    ...
                    echo    '<td class="col-8 col-sm-4 col-xl-4 text-start text-break">
                                ...
                                <td class="col-3 col-sm-2 col-xl-1 ' . $bg . '" id="status">' . $Status_form_name . '</td>
                                <td class="col-2 col-sm-1 col-xl-1">';
    ...
    <?php if (isset($_POST['search']) || isset($_GET['page'])) { ?>
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <li class="page-item"><a class="page-link" href="indexAdmin.php?page=1">
                        <<< /a>
                </li>
                ...
                ?>
                    <li class="page-item"><a class="page-link text-decoration-none <?= $active ?>" href="indexAdmin.php?page=<?= $page ?>"><?= $page ?></a></li>
                <?php } ?>
                <li class="page-item"><a class="page-link text-decoration-none" href="indexAdmin.php?page=<?= $number_of_page ?>">>></a></li>
            </ul>
        </nav>
    <?php } else { ?>
        <nav aria-label="Page navigation example ">
            <ul class="pagination justify-content-center ">
                <li class="page-item"><a class="page-link text-decoration-none" href="indexAdmin.php?page1=1">
                        <<< /a>
                </li>
                ...
                ?>
                    ...
                    <li class="page-item"><a class="page-link <?= $active ?>" href="indexAdmin.php?page1=<?= $page1 ?>"><?= $page1 ?></a></li>
                <?php } ?>
                <li class="page-item"><a class="page-link" href="indexAdmin.php?page1=<?= $number_of_page1 ?>">>></a></li>
            </ul>
        </nav>
    <?php } ?>
