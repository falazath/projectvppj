    ...
    <form action="" method="post">
        ...
        <div class="row justify-content-start mb-0 mb-xl-3" id="dsk">
            <div class="col-10 col-xl-4 mb-3 mb-xl-0">
                ...
                <input type="text" class="data form-control ftitle" name="contact" id="contact" value="<?= $data['Form_Name'] ?>" disabled>
            </div>
            <div class="col-10 col-xl-4 mb-3 mb-xl-0">
                <p class="ftitle fw-bold mb-1">หน่วยงาน</p>
                <input type="text" class="data form-control ftitle" name="sector" value="Origin Plug&Play Srinakarin" disabled>
            </div>
            <div class="col-10 col-xl-4 mb-3 mb-xl-0">
            ...
            <div class="col-xl-6 mb-3 mb-xl-0">
                ...
                <div class="col-10 col-xl-12 align-items-center">
                    <div class="form-check form-check-inline">
                        <input class="data form-check-input my-0 me-1" type="checkbox" id="software" value="1" checked disabled>
                        <label class="form-check-label" for="software">ซอฟต์แวร์</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="data form-check-input my-0 me-1" type="checkbox" id="hardware" value="2" checked disabled>
