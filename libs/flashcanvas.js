...
window.ActiveXObject && !window.CanvasRenderingContext2D && function () {
    ...
    function F(a) {
        var b = parseInt(a.width, 10), c = parseInt(a.height, 10); if (isNaN(b) || 0 > b) b = 300; if (isNaN(c) || 0 > c) c = 150; a.width = b; a.height = c
    }
    ...
    a: {
        ...
        if (u) for (I = n[u - 1].src || ""; u;) {
            script = n[u - 1]; if (script.src && script.src.match("flashcanvas")) { n = 8 <= G.documentMode ? script.src : script.getAttribute("src", 4); break a } u--
        } n = I
    }
    var K = n.replace(/[^\/]+$/, ""), e = new function (a) {
        ...
        v = {}, p = {}, q = {}, x = {}, y = {}, w = function (a, b) {
            ...
            this._executeCommandIntervalID = setInterval(function () {
                for (var a = c.canvas, b = !1, a = a.parentNode; a && !b;)b = a.body, a = a.parentNode; b ? 0 === q[c._canvasId] && c._executeCommand() : clearInterval(c._executeCommandIntervalID)
            }, 30)
        };
    w.prototype = {
        save: function () {
        ...
        scale: function (a, b) { this._queue.push(e.scale, a, b) },
        rotate: function (a) { this._queue.push(e.rotate, a) },
        translate: function (a, b) { this._queue.push(e.translate, a, b) },
        transform: function (a, b, c, d, f, g) { this._queue.push(e.transform, a, b, c, d, f, g) },
        setTransform: function (a, b, c, d, f, g) { this._queue.push(e.setTransform, a, b, c, d, f, g) },
        ...
        _setFillStyle: function () {
            if (this._fillStyle !== this.fillStyle) {
                ...
                if ("string" !== typeof a) if (a instanceof r || a instanceof z) a = a.id;
                else return;
        ...
        createRadialGradient: function (a, b, c, d, f, g) {
            (!isFinite(a) || !isFinite(b) || !isFinite(c) || !isFinite(d) || !isFinite(f) || !isFinite(g)) && i(9); (0 > c || 0 > g) && i(1);
        ...
        createPattern: function (a, b) {
            ...
            if (c) if (c = c.toLowerCase(), "img" === c) d = a.getAttribute("src", 2);
            else {
                if (c === t || "video" === c) return;
                i(17)
            } else a.src ? d = a.src : i(17); "repeat" === b || ("no-repeat" === b || "repeat-x" === b || "repeat-y" === b || "" === b || null === b) || i(12);
            this._queue.push(
                e.createPattern,
                s(d), b); !p[f][d] && v[f] && (this._executeCommand(),
                    ++q[f], p[f][d] = !0);
            return new z(this)
        },
        ...
        clip: function () { this._queue.push(e.clip) },
        ...
        _setFontStyles: function () {
            ...
            if (this._font !== this.font) try {
                ...
                a.push(e.font, d)
            } catch (f) { } this._textAlign !== this.textAlign && (
        ...
        measureText: function (a) {
            var b = y[this._canvasId];
            try { b.style.font = this.font } catch (c) { } b.innerText = a.replace(/[ \n\f\r]/g, "\t");
            return new L(b.offsetWidth)
        },
        drawImage: function (a, b, c, d, f, g, j, M, N) {
            a || i(17);
            var h = a.tagName, k, l = arguments.length, A = this._canvasId;
            if (h) if (h = h.toLowerCase(), "img" === h) k = a.getAttribute("src", 2);
            else {
        ...
        loadImage: function (a, b, c) {
            var d = a.tagName, f, g = this._canvasId; d ? "img" === d.toLowerCase() && (f = a.getAttribute("src", 2)) : a.src && (f = a.src);
            if (f && !p[g][f]) {
                if (b || c) x[g][f] = [a, b, c]; this._queue.push(e.drawImage, 1, s(f));
        ...
        _initialize: function () {
            ...
            this.fillStyle = this._fillStyle = this.strokeStyle = this._strokeStyle = "#000000"; this.lineWidth = this._lineWidth = 1;
            ...
            if (0 < a.length) try {
                return eval(
                    this._swf.CallFunction(
                        '<invoke name="executeCommand" returntype="javascript"><arguments><string>' + a.join("&#0;") + "</string></arguments></invoke>"
                    ))
            } catch (b) { }
        },
    ...
    var J = "initElement",
        m = {
            ...
            initWindow: function (a) {
                ...
                var d = this.canvases,
                    ...
                    g = function () {
                        ...
                        for (B in d) if (
                            b = d[B],
                            c = b.firstChild,
                            k = b.ownerDocument.defaultView ? b.ownerDocument.defaultView : b.ownerDocument.parentWindow,
                            a === k
                        ) {
                ...
                "complete" === a.document.readyState ? b() : a.document.attachEvent(H, b)
            }
        };
    m[J] = function (a) {
        ...
        var d = Math.random().toString(36).slice(2) || "0", f = "external" + d; v[d] = !1;
        p[d] = {};
        q[d] = 1;
        x[d] = {};
        ...
        F(a);
        var g = D(c);
        a.innerHTML = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="' + ("https:" === c.location.protocol ? "https:" : "http:") + '//fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="100%" height="100%" id="' + f + '"><param name="allowScriptAccess" value="always"><param name="flashvars" value="id=' + f + '"><param name="wmode" value="transparent"></object><span style="margin:0;padding:0;border:0;display:inline-block;position:static;height:1em;overflow:visible;white-space:nowrap"></span>';
        this.canvases[d] = a;
        var j = a.firstChild;
        y[d] = a.lastChild;
        var i = b.body.contains;
        if (i(a)) j.movie = g;
        else var m = c.setInterval(function () { i(a) && (c.clearInterval(m), j.movie = g) }, 2);
        if ("BackCompat" === b.compatMode || !c.XMLHttpRequest) y[d].style.overflow = "hidden";
        var h = new w(a, j); a.getContext = function (a) { return "2d" === a ? h : null };
            ...
            if (void 0 === b)
                d = this.canvases[a],
                    ...
                    b = function (a) {
                        ...
                        if ("width" === b || "height" === b) {
                            var a = a.srcElement,
                                c = a[b], d = parseInt(c, 10);
                            if (isNaN(d) || 0 > d) d = "width" === b ? 300 : 150; c === d ? (
                    ...
                    v[a] = !0, "function" === typeof d.onload && l.setTimeout(function () {
                        d.onload()
                    }, 0);
            else if (i = x[a][b]) m = i[0], h = i[1 + c], delete x[a][b], "function" === typeof h && h.call(m); q[a] && --q[a]
        } catch (n) {
